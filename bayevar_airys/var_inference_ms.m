function [negF,wopt,Ropt,epsbf,d0bf] = ...
    var_inference_ms(theta,sig_m,dm,entry,exit,nhat,nsegs,L,nu,d0_const,num_basis1,num_basis2,X,Y,Xt,Yt,ntrac,sig_t,display)
% Finds the approximate posterior that maximises the free energy
% this function is for non-convex geometry
...
for i = 1:max_iters          % until convergence of free energy
    ...
    backward_steps = 0;
    alpha = alpha_save;
    for k = 0:52        % max steps in line search
